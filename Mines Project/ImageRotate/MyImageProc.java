...
public class MyImageProc extends JFrame {
    ...
    private JButton InputPhotoButton;    // Button to trigger blur operator
    ...
    private void buildComponents() {
        ...
        view = new MyImageObj(readImage("boat2.jpeg"));
        //view = new MyImageObj();
        infoLabel = new JLabel("Original Image");
        OriginalButton = new JButton("Reset");
        SharpenButton = new JButton("Quit");
        ResetButton = new JButton("Reset");
        QuitButton = new JButton("Quit");
        InputPhotoButton = new JButton("Input Photo");
        ...
        ThreshLabel = new JLabel("Rotate Value: 128");
        thresholdslider = new JSlider( SwingConstants.VERTICAL, -360, 360, 0);
        int[] currentVal = {0};
        ...
        thresholdslider.addChangeListener(
                new ChangeListener() {
                    public void stateChanged (ChangeEvent e) {
                        ...
                        infoLabel.setText("Rotate Image");
                        ThreshLabel.setText("Rotate Value: " +
                                Integer.toString(thresholdslider.getValue()));
                        rotation+=(currentVal[0] - thresholdslider.getValue());
                        view.ApplyAffine(rotation);
                        currentVal[0] = thresholdslider.getValue();
                    }
                }
        );
        ...
        InputPhotoButton.addActionListener(
                new ActionListener () {
                    public void actionPerformed (ActionEvent e) {
                        infoLabel.setText("Input Photo");
    ...
    private void buildDisplay () {
       ...
       controlPanel.add(infoLabel);
        ...
        controlPanel.add(InputPhotoButton);
